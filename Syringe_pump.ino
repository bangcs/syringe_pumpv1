...
String arah = "berlawanan jarum jam";
//
void setup() {
...
void heavy_rotation(){
  // step dari motordriver ingin berlawanan atau searah
   steps = steps * -1;
   if (steps == -1){
    arah = "searah jarum jam"; // jika nilainya -1 maka akan searah jarumjam
   }
   else{
    arah = "berlawanan arah jarumjam"; // jika nilainya 1 maka akan berlawanan arah jarum jam
   }
   Serial.println(arah);
}
